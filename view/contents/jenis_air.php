        ...
        <div class="main-card mb-3 card">
            <div class="card-header">Jenis Air
                <div class="btn-actions-pane-right">
                    <a href="<?php $_SERVER['DOCUMENT_ROOT'] . '/wepeak?menu=jenis_air&aksi=tambah'; ?>"
                ...
                <table class="align-middle mb-0 table table-borderless table-striped table-hover datatable">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?=$base_url . "view/index.php?action=delete&id=" . $data['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin Menghapus Data Tersebut?');">Hapus</a>
                          </form>
                        </td>
                    </tr>
                  <?php endforeach; ?>
